...
### Операційні правила системи

1. **Мова інтерфейсу та сповіщень**: Системні інструкції ШІ пишуться англійською для точності логіки, але вивід для користувача (пуш, опис, деталі) має бути виключно українською мовою.
