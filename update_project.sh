...
# Create or update SirenUA.xcodeproj/project.pbxproj with new files
...
/* Begin PBXNativeTarget section */
		C4 /* SirenUA */ = {
			isa = PBXNativeTarget;
			buildConfigurationList = C5 /* Build configuration list for PBXNativeTarget "SirenUA" */;
			buildPhases = (
				C6 /* Sources */,
				C0 /* Frameworks */,
				C7 /* Resources */,
			...
			name = SirenUA;
			productName = SirenUA;
			productReference = BF /* SirenUA.app */;
...
/* Begin PBXProject section */
		C8 /* Project object */ = {
			...
			buildConfigurationList = C9 /* Build configuration list for PBXProject "SirenUA" */;
...
/* Begin XCConfigurationList section */
		C5 /* Build configuration list for PBXNativeTarget "SirenUA" */ = {
		...
		C9 /* Build configuration list for PBXProject "SirenUA" */ = {
			isa = XCConfigurationList;
			buildConfigurations = (
				CA /* Debug */,
				CB /* Release */,
