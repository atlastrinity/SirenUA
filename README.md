...
- 🗺️ **Інтерактивна тактична карта України**:
  ...
  - **Індикатор напрямку літаків-носіїв (`CarrierApproachDirectionView`)**: На пунктирних лініях підльоту від далеких авіабаз (Оленья, Енгельс-2, Саваслейка) до пускових рубежів відображається тактична капсула з матового скла, яка містить анімовану янтарну стрілочку руху вперед та силует борту. Значок динамічно масштабується при наближенні карти аналогічно до рамок областей і табличок вильоту, зберігаючи жорстку орієнтацію за курсом польоту.
